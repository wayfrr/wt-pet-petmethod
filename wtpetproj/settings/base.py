"""
Django settings for wtpetproj project.
...
WSGI_APPLICATION = 'wtpetproj.wsgi.application'
...
SOCIALACCOUNT_AUTO_SIGNUP = False # to make the user Fill in all the required fields.
